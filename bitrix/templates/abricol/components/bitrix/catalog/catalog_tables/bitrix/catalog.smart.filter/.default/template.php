...
$texts=array(
	97 => "Минимальный размер помещения 4.9х4 м",
  17 => "Размер игрового поля 8-и футового стола: 2,24х1,12 м. Бильярдная комната должна быть не меньше 5,74х4,62 м",
  18 => "Размер игрового поля 9-ти футового стола: 2,54х1,27 м. Бильярдная комната должна быть не меньше 6,04х4,77 м",
  19 => "Размер игрового поля 10-ти футового стола: 2,84х1,42 м. Бильярдная комната должна быть не меньше 6,34х4,92 м",
  80 => "Размер игрового поля 11-ти футового стола: 3,20х1,60 м. Бильярдная комната должна быть не меньше 6,70х5,10 м",
  20 => "Размер игрового поля 12-ти футового стола: 3,50х1,75 м. Бильярдная комната должна быть не меньше 7,00х5,25 м",
);
if( isset( $_REQUEST["filter"][9] ) && $_REQUEST["filter"][9] && isset( $texts[$_REQUEST["filter"][9]] ) ){
	$text = $texts[$_REQUEST["filter"][9]];
}
else{
	$text = $texts[97];
}
        ...
        foreach($arResult["ITEMS"] as $key=>$arItem){
	        ...
	        <div class="select">
	          <div class="lineForm">
				...
				$prices=array(
					"0-50000" => "до 50000",
					"50001-100000" => "до 100000",
					"100001-150000" => "до 150000",
					"150001-250000" => "до 250000",
					"250001" => "от 250000"
				);
				?>
        <div class="select">
          <div class="lineForm">
            <select class="sel80" name="filter[price]">
