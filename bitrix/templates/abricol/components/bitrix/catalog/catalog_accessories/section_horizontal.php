...
<?$APPLICATION->ShowViewContent("category-text-top");?>
...
<div class="<?=($isSidebar ? "col-md-9 col-sm-8" : "col-xs-12")?>">
	<?$APPLICATION->IncludeComponent(
		...
		array(
			...
			"SECTION_USER_FIELDS" => array("UF_PRICE_FROM","UF_PRICELIST","UF_PRICELIST_TITLE")
		),
		$component,
		array("HIDE_ICONS" => "Y")
	);?>
	...
	<?endif?>
		...
		$APPLICATION->IncludeFile("catalog-filter/filter.php",$arParams);
		$APPLICATION->IncludeFile("catalog-filter/sort.php",$arParams);
