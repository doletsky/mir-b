			...
			?>
				<div>
					...
					foreach ($arSource as $arProperties)
					{
						...
						<?
						if ($arProperties["TYPE"] == "CHECKBOX1")
						{
							?>
						...
						{
							?>
					<div class="input2"><?/*?> Переносим NAME в placeholder и разваричиваем input во всю длину стилями 
                <label><?=$arProperties["NAME"]?>
									<?if ($arProperties["REQUIED_FORMATED"]=="Y"):?>
										<span class="bx_sof_req">*</span>
									<?endif;?>
</label><?*/?>
                <input type="text" value="<?=$arProperties["VALUE"]?>" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>" placeholder="<?=$arProperties["NAME"]?> <?if ($arProperties["REQUIED_FORMATED"]=="Y") echo "*";?>">
                <!--input type="text" class="inp_mob" name="<?=$arProperties["FIELD_NAME"]?>_mob" placeholder="<?=$arProperties["NAME"]?>"-->
              </div>
							<?
						}
						...
						elseif ($arProperties["TYPE"] == "TEXTAREA")
						{
							...
							?>
							<div class="input2">
                <textarea rows="10" cols="10" placeholder="<?=$arProperties["NAME"]?>" class="textarea" name="<?=$arProperties["FIELD_NAME"]?>" id="<?=$arProperties["FIELD_NAME"]?>"><?=$arProperties["VALUE"]?></textarea>
              </div>
							<?
						}
                ...
                <input type="text" class="inp_mob" name="<?=$arProperties["FIELD_NAME"]?>_mob">
