...
?>
<fieldset>
  <div class="h2">Корзина заказа</div>
  <div class="cart_tab" id="basket_items">
    <div class="col_th_1 col_th">Фото и наименование товара</div>
    ...
    foreach ($arResult["GRID"]["ROWS"] as $k => $arItem){
		...
		?>
    <div class="cart_tab_row" id="<?=$arItem["ID"]?>">
      <div class="col_td_1 col_td">
        <a href="<?=$arItem["DETAIL_PAGE_URL"]?>" class="item_preview"><img src="<?=MakeImage($arItem["PREVIEW_PICTURE_SRC"],array("w"=>66,"h"=>40))?>" alt=""></a>
        <a class="item_name" href="<?=$arItem["DETAIL_PAGE_URL"]?>"><?=$arItem["~NAME"]?>
      ...
      <div class="col_td_3 col_td"><?=str_replace("руб.","",$arItem["PRICE_FORMATED"])?> <span class="rub">i</span></div>
      <div class="col_td_4 col_td"><?=str_replace("руб.","",$arItem["SUM"])?> <span class="rub">i</span></div>
      <div class="col_td_5 col_td"><a href="<?=str_replace("#ID#", $arItem["ID"], $arUrls["delete"])?>" class="delete"></a></div>
      <div class="clear"></div>
    </div>
    <?
    	}
    ...
    <div class="total_sum" id="allSum_FORMATED1"><?=str_replace("руб.","",$arResult["allSum_FORMATED"])?><span class="rub">i</span></div>
    <div class="clear"></div>
  </div>
  ...
  <div class="order_wrap">
    <div class="order_box">
      ...
      <div class="order_head">
        <p>Сумма заказа <span class="strong" id="allSum_FORMATED"><?=str_replace("руб.","",$arResult["allSum_FORMATED"])?><span class="rub">i</span></span></p>
      </div>
      <div class="order_body">
        ...
        <input type="button" value="Оформить заказ" class="button close-reveal-modal" onclick="checkOut();">
      </div>
    </div>
											...
											<tr>
												<td>
													...
													<input
														type="text"
														size="3"
														id="QUANTITY_INPUT_<?=$arItem["ID"]?>__"
														name="QUANTITY_INPUT_<?=$arItem["ID"]?>"
														size="2"
														maxlength="18"
														min="0"
			...
			<table class="bx_ordercart_order_sum">
				...
				<?endif;?>
					...
					<tr>
						...
						<td class="fwb" id="allSum_FORMATED2"><?=str_replace(" ", "&nbsp;", $arResult["allSum_FORMATED"])?></td>
					</tr>
					<tr>
