  ...
  <div class="cart_tab" id="basket_items">
    ...
    <div class="cart_tab_row" id="<?=$arItem["ID"]?>">
      <div class="col_td_1 col_td">
        <a href="<?=$arItem["DETAIL_PAGE_URL"] ?>" class="item_preview"><img src="<?=SITE_TEMPLATE_PATH?>/img/temp/cart_preview_1.jpg" alt=""></a>
  ...
  <div class="order_wrap">
    <div class="order_box">
      ...
      <div class="order_head">
        <p>Сумма заказа <strong id="allSum_FORMATED"><?=str_replace("руб.","",$arResult["allSum_FORMATED"])?><span class="rub">i</span></strong></p>
      </div>
