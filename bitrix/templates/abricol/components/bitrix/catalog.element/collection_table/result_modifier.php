...
// lex sv
#$arSortFields["SKU_SORT_SIZE"]=SORT_DESC;
#pre($arSortFields);
...
foreach($arResult["OFFERS"] as &$arItem){
	...
	switch( $size ){
		...
		case '8':
		case '9':
			$arItem["GAME_TYPE"]="Пирамида/пул";
			break;
		case '10':
		case '11':
		case '12':
			$arItem["GAME_TYPE"]="Пирамида";
			break;
	}
	if( !in_array($arItem["GAME_TYPE"],$arResult["GAME_TYPE"]) ) $arResult["GAME_TYPE"][]=$arItem["GAME_TYPE"];
	...
	$arItem["TREE"]["PROP_8"]=$arItem["GAME_TYPE"];
}
